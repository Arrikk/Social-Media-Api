            ...
            <div class="card-inner p-0">
                <div class="nk-tb-list nk-tb-ulist">
                    <div class="nk-tb-item nk-tb-head">
                        ...
                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">By</span></div>
                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Joined Date</span></div>
                        <div class="nk-tb-col tb-col-xl"><span class="sub-text">Verified</span></div>
